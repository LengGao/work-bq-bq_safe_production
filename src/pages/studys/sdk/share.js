...
// course_id: id, url: location.href
export async function stare_WeixinJSBridge(course_id, url) {
    var wx = require('weixin-js-sdk')
    wx.request({
        url: 'https://store.beiqujy.com/apidata/applet/user/share/getShareConfig',
        data: {course_id, url},
        dataType: 'json',
        success(res) {
