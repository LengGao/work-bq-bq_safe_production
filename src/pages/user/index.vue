...
<view class="user">
    ...
    <view class="links">
        <uni-list class="list">
            <uni-list-item v-for="link in links" :key="link.id"
                :to="link.url" :title="link.title" @click="onClickList(link.id)"
                showArrow clickable
            >
...
export default {
    ...
    data() {
        return {
            ...
            listIndex: 0,
            links: [
                {id: 1, thumb: '../../static/logo.png', title: "课程收藏" , url: ''},
                {id: 2, thumb: '../../static/logo.png', title: "意见反馈" , url: ''},
                {id: 3, thumb: '../../static/logo.png', title: "关于我们" , url: ''},
            ]
        }
    },
    methods: {
